        ...
        function render(req, res) {
            ...
            try {
                ...
                var lineVisQueries = [
                    ...
                    'PDC-026', 'PDC-027', 'PDC-028', 'PDC-1738'
                ],
                            ...
                            if( error ){
                                ...
                                switch( error ){
                                    ...
                                    case 204:
                                        ...
                                        res.status(404);
                                        res.render('error', {message : 'Successfully fetched report '+t+', but it had no data.', redirect : '/'});
                                        return; 
                                        break; 
                                    ...
                                    case 400:
                                        ...
                                        res.status(400);
                                        res.render("error", {message : "routes: Failed to fetch report"+t, redirect : '/'})
                                        return; 
                                        break; 

    ...
    router.get("/amcare",
        ...
        function render(req, res) {
            ...
            return res.render('error', {
                    message : "AMCARE Export is currently not supported, we are working on it!",
                    redirect: "/population-health"
                }
            );
        }
    );
        ...
        function render(req, res) {
            ...
            try {
                ...
                if (demoPyramidQueries.indexOf(req.params.title) > -1) {
                    ...
                    req.visualization.script.pyramid = 'DemographicsPyramidVis';

                } else if (clusterBarVisQueries.indexOf(req.params.title) > -1) {

                    req.visualization.script = 'ClusterBarVis';

                }else if (ratioQueries.indexOf(req.params.title) > -1) {

                    req.visualization.script = 'ratioViz';

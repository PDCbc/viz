              ...
              require('request').get(
                ...
                function (error, response, body) {
                    ...
                    switch( response.statusCode ){
                        ...
                        case 404: 
                            logger.warn("middleware.hubapiGet() : Unable to reach hubapi, error was:  "+util.inspect(error, false, null)); 
                            next(404, null);
        ...
        try{
          ...
          hubapiGet(req, '/api/queries', function validation(error, response) {
            ...
            if (error) {  //an error code 400, 401, 500...
                ...
                req.integrity_queries = response.body.queries.filter(
        ...
        hubapiGet(req, address, function validation(error, request) {
            ...
            if ( error ){
                ...
                switch(error){
                    ...
                    case 204:
                        res.render('error', { message : "middleware.populateVisualizationList could not find executions for query: "+req.params.title, redirect : '/'}); 
                        return;
                        break;
                    ...
                    default:
                        ...
                        res.render('error', { message : "middleware.populateVisualizationList failed with status code:" + error, redirect : '/'}); 
                        return; 
                        break; 

...
function middleware(next, data) {
    ...
    function hubapiGet(req, path, next) {
        ...
        try {
			...
			//the path thing for the url is a horrible hack
			//the hupapiget method and populatevisualizationlist need to be refactored
			//to make this cleaner --- populatevisualizationlist is a legacy middleware
			//from an early prototype that shouldn't be needed except that is also fetches
			//the data to be displayed.
			
			path = (path === '/demographics/') ? path + req.params.title : path;
                            ...
                            function (error, response, body) {
                                ...
                                try {
                                    ...
                                    if (!response || !response.statusCode) {
                                        ...
                                        logger.warn("Failed to get response from HAPI for request to path: " + path);
                                        next(404, null);
                                        return;
                                    ...
                                    switch (response.statusCode) {
                                        ...
                                        default:
                                            ...
                                            return next(response.statusCode, null);
                                            break;
                                    ...
                                    logger.log(e.stack);
                                    logger.error("middleware.hubapiGet() caught an exception: " + util.inspect(e, false, null));
                                    return next(500, null);
                    ...
                    if (error) {  //an error code 204, 400, 401, 500...
                        ...
                        switch (error) {
                            ...
                            case 401:
                                ...
                                res.status(401);
                                res.render('error', {
                                    message : "middleware.populateVisualizationList failed due to failure to authenticate.",
                                    redirect: '/auth'
                                });
                                break;
                            ...
                            case 500:
                                ...
                                res.status(500);
                                res.render('error', {
                                    message : 'middleware.populateVisualizationList failed due to a server failure.',
                                    redirect: '/'
                                });
                                break;
                            ...
                            case 404:
                                ...
                                res.status(404);
                                res.render('error', {
                                    message : 'middleware.populateVisualizationList failed due auth or hubapi being unreachable',
                                    redirect: '/'
                                });
                                break;
    ...
    function populateVisualization(req, res, callback) {
        ...
        try {
            ...
            if (!req.params.title) {
                ...
                res.render('error', {
                    message : 'please provide a title for the visualization in the URL.',
                    redirect: '/'
                });
                return;
            ...
            } else if (req.params.title === 'PDC-001' || req.params.title === "PDC-1740") {

                address = '/demographics/';

            } else if (req.params.title.indexOf('PDC') === 0) {

                address = '/retro/' + req.params.title + '/';
            ...
            hubapiGet(req, address, function validation(error, request) {
                ...
                try {
                    ...
                    if (error) {
                        ...
                        switch (error) {
                            ...
                            case 204:
                                ...
                                res.status(404);
                                res.render('error', {
                                    message : "middleware.populateVisualization could not find executions for query: " + req.params.title,
                                    redirect: '/'
                                });
                                return;
                                break;
                            ...
                            case 401:
                                ...
                                res.status(401);
                                res.render('error', {
                                    message : "middleware.populateVisualization failed due to failure to authenticate.",
                                    redirect: '/auth'
                                });
                                return;
                                break;
                            ...
                            case 404:
                                ...
                                res.status(404);
                                res.render('error', {
                                    message : 'the query: ' + req.params.title + ' does not exist in the database. ',
                                    redirect: '/'
                                });
                                return;
                                break;
                            ...
                            case 500:
                                ...
                                res.status(500);
                                res.render('error', {
                                    message : 'middleware.populateVisualization failed due to a server failure.',
                                    redirect: '/'
                                });
                                return;
                                break;
                            ...
                            default:
                                ...
                                res.status(500);
                                res.render('error', {
                                    message : "middleware.populateVisualization failed with status code:" + error,
                                    redirect: '/'
                                });
                                return;
                                break;
                    ...
                    if (request && request.body) {
                        ...
                        res.status(500);
                        res.render('error', {message: "middleware.populateVisualization failed", redirect: '/'});
                        return;
                    ...
                    res.status(500);
                    res.render('error', {
                        message : "middleware.populateVisualization failed wth an exception",
                        redirect: '/'
                    });
            ...
            logger.error("Caught exception in middleware.populateVisualization() : " + util.inspect(e, false, null));
            res.status(500);
            res.render('error', {message: "middleware.populateVisualization failed wth an exception", redirect: '/'});
            ...
            hubapiGet(req, '/reports',
                ...
                function validation(error, response) {
                    ...
                    try {
                        ...
                        if (error) {
                            ...
                            switch (error) {
                                ...
                                case 404:
                                    ...
                                    res.status(404);
                                    res.render('error', {
                                        message : 'Could not communicate with hubapi or auth.',
                                        redirect: '/'
                                    });
                                    break;
                        ...
                        logger.error("middleware.populateReportsList() caught an exception: " + util.inspect(e, false, null));
                    ...
                    try {
                        ...
                        if (err) {
                            ...
                            if (!authResult || !authResult.cookie) {
                                ...
                                res.statusCode = 500;
                                res.render('error', {
                                    message : "Could not obtain a session from auth.",
                                    redirect: '/auth'
                                });
                                return;
                                ...
                                auth.verifyAuth(authResult.cookie, function (err, user) {
                                    ...
                                    try {
                                        ...
                                        if (err) {
                                            ...
                                            res.statusCode = 500;
                                            res.render('error', {
                                                message : "Could not verify session with auth.",
                                                redirect: '/auth'
                                            });
                                            callback(err)
                                        ...
                                        logger.error("middleware.authenticateUser caught an exception: " + util.inspect(e, false, null));
                                        res.statusCode = 500;
                                        res.render('error', {
                                            message : "An exception occured: " + util.inspect(e, false, null),
                                            redirect: '/auth'
                                        });
                                        return;
